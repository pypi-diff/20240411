# Comparing `tmp/aioxdl-0.0.6.tar.gz` & `tmp/aioxdl-0.0.7.tar.gz`
...
## Comparing `aioxdl-0.0.6.tar` & `aioxdl-0.0.7.tar`
...
### Comparing `aioxdl-0.0.6/LICENSE` & `aioxdl-0.0.7/LICENSE`

 * *Files identical despite different names*

### Comparing `aioxdl-0.0.6/PKG-INFO` & `aioxdl-0.0.7/PKG-INFO`
...
### Comparing `aioxdl-0.0.6/README.md` & `aioxdl-0.0.7/README.md`

 * *Files identical despite different names*

### Comparing `aioxdl-0.0.6/aioxdl/module.py` & `aioxdl-0.0.7/aioxdl/module.py`
...
### Comparing `aioxdl-0.0.6/aioxdl.egg-info/PKG-INFO` & `aioxdl-0.0.7/aioxdl.egg-info/PKG-INFO`
...
### Comparing `aioxdl-0.0.6/setup.py` & `aioxdl-0.0.7/setup.py`
