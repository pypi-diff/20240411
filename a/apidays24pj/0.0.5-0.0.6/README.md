# Comparing `tmp/apidays24pj-0.0.5.tar.gz` & `tmp/apidays24pj-0.0.6.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "apidays24pj-0.0.5.tar", last modified: Thu Apr 11 13:28:14 2024, max compression
+gzip compressed data, was "apidays24pj-0.0.6.tar", last modified: Thu Apr 11 13:52:55 2024, max compression
```

## Comparing `apidays24pj-0.0.5.tar` & `apidays24pj-0.0.6.tar`

### file list

```diff
@@ -1,21 +1,21 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-11 13:28:14.822099 apidays24pj-0.0.5/
--rw-r--r--   0 runner    (1001) docker     (127)    11358 2024-04-11 13:28:04.000000 apidays24pj-0.0.5/LICENSE
--rw-r--r--   0 runner    (1001) docker     (127)       23 2024-04-11 13:28:04.000000 apidays24pj-0.0.5/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (127)      876 2024-04-11 13:28:14.822099 apidays24pj-0.0.5/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)       18 2024-04-11 13:28:04.000000 apidays24pj-0.0.5/README.md
--rw-r--r--   0 runner    (1001) docker     (127)      234 2024-04-11 13:28:04.000000 apidays24pj-0.0.5/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-04-11 13:28:14.822099 apidays24pj-0.0.5/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)     1684 2024-04-11 13:28:04.000000 apidays24pj-0.0.5/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-11 13:28:14.818099 apidays24pj-0.0.5/src/
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-11 13:28:14.822099 apidays24pj-0.0.5/src/apidays24pj/
--rw-r--r--   0 runner    (1001) docker     (127)   741610 2024-04-11 13:28:04.000000 apidays24pj-0.0.5/src/apidays24pj/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-11 13:28:14.822099 apidays24pj-0.0.5/src/apidays24pj/_jsii/
--rw-r--r--   0 runner    (1001) docker     (127)      472 2024-04-11 13:28:04.000000 apidays24pj-0.0.5/src/apidays24pj/_jsii/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)   101497 2024-04-11 13:28:04.000000 apidays24pj-0.0.5/src/apidays24pj/_jsii/apidays24pj@0.0.5.jsii.tgz
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-11 13:28:04.000000 apidays24pj-0.0.5/src/apidays24pj/py.typed
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-11 13:28:14.822099 apidays24pj-0.0.5/src/apidays24pj.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)      876 2024-04-11 13:28:14.000000 apidays24pj-0.0.5/src/apidays24pj.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      383 2024-04-11 13:28:14.000000 apidays24pj-0.0.5/src/apidays24pj.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-11 13:28:14.000000 apidays24pj-0.0.5/src/apidays24pj.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)      108 2024-04-11 13:28:14.000000 apidays24pj-0.0.5/src/apidays24pj.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)       12 2024-04-11 13:28:14.000000 apidays24pj-0.0.5/src/apidays24pj.egg-info/top_level.txt
...
### Comparing `apidays24pj-0.0.5/LICENSE` & `apidays24pj-0.0.6/LICENSE`

 * *Files identical despite different names*

### Comparing `apidays24pj-0.0.5/PKG-INFO` & `apidays24pj-0.0.6/PKG-INFO`
...
### Comparing `apidays24pj-0.0.5/setup.py` & `apidays24pj-0.0.6/setup.py`
...
### Comparing `apidays24pj-0.0.5/src/apidays24pj/__init__.py` & `apidays24pj-0.0.6/src/apidays24pj/__init__.py`
...
### Comparing `apidays24pj-0.0.5/src/apidays24pj.egg-info/PKG-INFO` & `apidays24pj-0.0.6/src/apidays24pj.egg-info/PKG-INFO`
