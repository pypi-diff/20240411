# Comparing `tmp/bc-detect-secrets-1.5.5.tar.gz` & `tmp/bc-detect-secrets-1.5.6.tar.gz`
...
### Comparing `bc-detect-secrets-1.5.5/README.md` & `bc-detect-secrets-1.5.6/README.md`
