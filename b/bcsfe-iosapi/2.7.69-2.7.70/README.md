# Comparing `tmp/bcsfe-iosapi-2.7.69.tar.gz` & `tmp/bcsfe-iosapi-2.7.70.tar.gz`
...
### Comparing `bcsfe-iosapi-2.7.69/src/BCSFE_Python_Discord/__main__.py` & `bcsfe-iosapi-2.7.70/src/BCSFE_Python_Discord/__main__.py`
