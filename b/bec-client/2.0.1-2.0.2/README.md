# Comparing `tmp/bec_client-2.0.1.tar.gz` & `tmp/bec_client-2.0.2.tar.gz`
...
### Comparing `bec_client-2.0.1/bec_client/beamline_mixin.py` & `bec_client-2.0.2/bec_client/beamline_mixin.py`
