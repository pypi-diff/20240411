# Comparing `tmp/bec_client-2.0.3.tar.gz` & `tmp/bec_client-2.1.0.tar.gz`
...
### Comparing `bec_client-2.0.3/bec_client/beamline_mixin.py` & `bec_client-2.1.0/bec_client/beamline_mixin.py`
