# Comparing `tmp/edc-0.5.81.tar.gz` & `tmp/edc-0.5.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "edc-0.5.81.tar", last modified: Thu Apr 11 00:26:43 2024, max compression
+gzip compressed data, was "edc-0.5.9.tar", last modified: Thu Jul 20 02:51:26 2023, max compression
```

## Comparing `edc-0.5.81.tar` & `edc-0.5.9.tar`

### file list

```diff
@@ -1,82 +1,75 @@
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2024-04-11 00:26:43.382364 edc-0.5.81/
--rw-r--r--   0 erikvw     (501) staff       (20)     1410 2022-05-03 03:22:05.000000 edc-0.5.81/.gitignore
--rw-r--r--   0 erikvw     (501) staff       (20)     1077 2024-02-13 18:05:12.000000 edc-0.5.81/.pre-commit-config.yaml
--rw-r--r--   0 erikvw     (501) staff       (20)      291 2022-08-08 18:50:02.000000 edc-0.5.81/.yamllint
--rw-r--r--   0 erikvw     (501) staff       (20)        0 2022-05-03 03:22:05.000000 edc-0.5.81/AUTHORS
--rw-r--r--   0 erikvw     (501) staff       (20)    65975 2024-04-11 00:26:32.000000 edc-0.5.81/CHANGES
--rw-r--r--   0 erikvw     (501) staff       (20)    35147 2020-03-07 14:11:38.000000 edc-0.5.81/LICENSE
--rw-r--r--   0 erikvw     (501) staff       (20)      151 2020-03-07 14:11:38.000000 edc-0.5.81/MANIFEST.in
--rw-r--r--   0 erikvw     (501) staff       (20)    44528 2024-04-11 00:26:43.382263 edc-0.5.81/PKG-INFO
--rw-r--r--   0 erikvw     (501) staff       (20)    40358 2024-02-13 18:05:12.000000 edc-0.5.81/README.rst
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2024-04-11 00:26:43.364652 edc-0.5.81/bin/
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2024-04-11 00:26:43.367968 edc-0.5.81/bin/nginx/
--rw-r--r--   0 erikvw     (501) staff       (20)      350 2022-07-30 01:15:42.000000 edc-0.5.81/bin/nginx/edc-sites.conf
--rw-r--r--   0 erikvw     (501) staff       (20)      706 2022-07-30 01:15:42.000000 edc-0.5.81/bin/nginx/edc-uat.conf
--rw-r--r--   0 erikvw     (501) staff       (20)      656 2022-07-30 01:15:42.000000 edc-0.5.81/bin/nginx/edc.conf
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2024-04-11 00:26:43.368710 edc-0.5.81/bin/scripts/
--rw-r--r--   0 erikvw     (501) staff       (20)     2753 2022-10-05 21:50:32.000000 edc-0.5.81/bin/scripts/dev_repos.sh
--rw-r--r--   0 erikvw     (501) staff       (20)      276 2020-03-07 14:11:38.000000 edc-0.5.81/bin/scripts/list_db_files.sh
--rw-r--r--   0 erikvw     (501) staff       (20)      416 2020-03-07 14:11:38.000000 edc-0.5.81/bin/scripts/restore_db_file.sh
--rw-r--r--   0 erikvw     (501) staff       (20)     2408 2022-07-30 01:15:42.000000 edc-0.5.81/bin/scripts/update_edc.sh
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2024-04-11 00:26:43.369855 edc-0.5.81/bin/systemd/
--rw-r--r--   0 erikvw     (501) staff       (20)      835 2020-03-07 14:11:38.000000 edc-0.5.81/bin/systemd/celery-uat.service
--rw-r--r--   0 erikvw     (501) staff       (20)      820 2020-03-07 14:11:38.000000 edc-0.5.81/bin/systemd/celery.service
--rw-r--r--   0 erikvw     (501) staff       (20)      501 2020-03-07 14:11:38.000000 edc-0.5.81/bin/systemd/celerybeat-uat.service
--rw-r--r--   0 erikvw     (501) staff       (20)      487 2020-03-07 14:11:38.000000 edc-0.5.81/bin/systemd/celerybeat.service
--rw-r--r--   0 erikvw     (501) staff       (20)      485 2020-03-07 14:11:38.000000 edc-0.5.81/bin/systemd/gunicorn-uat.service
--rw-r--r--   0 erikvw     (501) staff       (20)      121 2020-03-07 14:11:38.000000 edc-0.5.81/bin/systemd/gunicorn-uat.socket
--rw-r--r--   0 erikvw     (501) staff       (20)      474 2020-03-07 14:11:38.000000 edc-0.5.81/bin/systemd/gunicorn.service
--rw-r--r--   0 erikvw     (501) staff       (20)      111 2020-03-07 14:11:38.000000 edc-0.5.81/bin/systemd/gunicorn.socket
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2024-04-11 00:26:43.374331 edc-0.5.81/docs/
--rw-r--r--   0 erikvw     (501) staff       (20)      634 2022-09-26 00:00:10.000000 edc-0.5.81/docs/Makefile
--rw-r--r--   0 erikvw     (501) staff       (20)    12978 2023-12-15 03:23:19.000000 edc-0.5.81/docs/README.rst
--rw-r--r--   0 erikvw     (501) staff       (20)    15486 2023-11-13 00:42:59.000000 edc-0.5.81/docs/backup.rst
--rw-r--r--   0 erikvw     (501) staff       (20)     5437 2022-07-30 01:15:42.000000 edc-0.5.81/docs/celery.rst
--rw-r--r--   0 erikvw     (501) staff       (20)     1531 2024-03-27 20:17:30.000000 edc-0.5.81/docs/conda.rst
--rw-r--r--   0 erikvw     (501) staff       (20)      975 2022-09-26 00:00:10.000000 edc-0.5.81/docs/conf.py
--rw-r--r--   0 erikvw     (501) staff       (20)     6596 2023-11-13 00:42:59.000000 edc-0.5.81/docs/configure_web_services.rst
--rw-r--r--   0 erikvw     (501) staff       (20)     3646 2023-01-25 02:44:13.000000 edc-0.5.81/docs/deploy_new_droplet.rst
--rw-r--r--   0 erikvw     (501) staff       (20)     9565 2023-08-04 04:47:01.000000 edc-0.5.81/docs/disaster_recovery.rst
--rw-r--r--   0 erikvw     (501) staff       (20)      163 2020-03-07 14:11:38.000000 edc-0.5.81/docs/dump_users.rst
--rw-r--r--   0 erikvw     (501) staff       (20)      845 2020-03-07 14:11:38.000000 edc-0.5.81/docs/exporting_encrypted_data.rst
--rw-r--r--   0 erikvw     (501) staff       (20)   258708 2022-07-30 01:15:42.000000 edc-0.5.81/docs/forms_reference.md
--rw-r--r--   0 erikvw     (501) staff       (20)      445 2022-09-26 00:00:10.000000 edc-0.5.81/docs/index.rst
--rw-r--r--   0 erikvw     (501) staff       (20)      643 2023-11-01 13:29:41.000000 edc-0.5.81/docs/landing_page.rst
--rw-r--r--   0 erikvw     (501) staff       (20)      765 2022-09-26 00:00:10.000000 edc-0.5.81/docs/make.bat
--rw-r--r--   0 erikvw     (501) staff       (20)     3928 2023-01-25 02:44:13.000000 edc-0.5.81/docs/prepare_database.rst
--rw-r--r--   0 erikvw     (501) staff       (20)     1211 2022-07-30 01:15:42.000000 edc-0.5.81/docs/printing.rst
--rw-r--r--   0 erikvw     (501) staff       (20)      187 2021-01-28 23:38:49.000000 edc-0.5.81/docs/redis.rst
--rw-r--r--   0 erikvw     (501) staff       (20)      766 2020-03-07 14:11:38.000000 edc-0.5.81/docs/update_deployment.rst
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2024-04-11 00:26:43.381708 edc-0.5.81/edc.egg-info/
--rw-r--r--   0 erikvw     (501) staff       (20)    44528 2024-04-11 00:26:43.000000 edc-0.5.81/edc.egg-info/PKG-INFO
--rw-r--r--   0 erikvw     (501) staff       (20)     1719 2024-04-11 00:26:43.000000 edc-0.5.81/edc.egg-info/SOURCES.txt
--rw-r--r--   0 erikvw     (501) staff       (20)        1 2024-04-11 00:26:43.000000 edc-0.5.81/edc.egg-info/dependency_links.txt
--rw-r--r--   0 erikvw     (501) staff       (20)        1 2024-03-27 20:17:39.000000 edc-0.5.81/edc.egg-info/not-zip-safe
--rw-r--r--   0 erikvw     (501) staff       (20)     1957 2024-04-11 00:26:43.000000 edc-0.5.81/edc.egg-info/requires.txt
--rw-r--r--   0 erikvw     (501) staff       (20)        6 2024-04-11 00:26:43.000000 edc-0.5.81/edc.egg-info/top_level.txt
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2024-04-11 00:26:43.378072 edc-0.5.81/image/
--rw-r--r--   0 erikvw     (501) staff       (20)    34744 2023-11-22 02:41:32.000000 edc-0.5.81/image/administration_appointment.png
--rw-r--r--   0 erikvw     (501) staff       (20)    14449 2023-11-22 02:41:32.000000 edc-0.5.81/image/administration_button.png
--rw-r--r--   0 erikvw     (501) staff       (20)     4335 2023-11-22 02:41:32.000000 edc-0.5.81/image/administration_icon.png
--rw-r--r--   0 erikvw     (501) staff       (20)   157606 2023-11-22 02:41:32.000000 edc-0.5.81/image/appointments.png
--rw-r--r--   0 erikvw     (501) staff       (20)   157606 2023-11-22 02:41:32.000000 edc-0.5.81/image/appointments_annotated_top.png
--rw-r--r--   0 erikvw     (501) staff       (20)    15845 2023-11-22 02:41:32.000000 edc-0.5.81/image/appointments_changelist.png
--rw-r--r--   0 erikvw     (501) staff       (20)     4708 2023-11-22 02:41:32.000000 edc-0.5.81/image/down_arrow.png
--rw-r--r--   0 erikvw     (501) staff       (20)   160721 2022-03-16 23:21:44.000000 edc-0.5.81/image/icon-pycharm.png
--rw-r--r--   0 erikvw     (501) staff       (20)      118 2023-09-26 19:26:40.000000 edc-0.5.81/pyproject.toml
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2024-04-11 00:26:43.381125 edc-0.5.81/requirements.tests/
--rw-r--r--   0 erikvw     (501) staff       (20)       21 2022-08-12 15:19:56.000000 edc-0.5.81/requirements.tests/coverage.txt
--rw-r--r--   0 erikvw     (501) staff       (20)       14 2022-08-10 01:27:44.000000 edc-0.5.81/requirements.tests/docs.txt
--rw-r--r--   0 erikvw     (501) staff       (20)     1158 2024-04-09 00:56:42.000000 edc-0.5.81/requirements.tests/edc.txt
--rw-r--r--   0 erikvw     (501) staff       (20)     4027 2024-02-11 18:40:59.000000 edc-0.5.81/requirements.tests/edc_dev.txt
--rw-r--r--   0 erikvw     (501) staff       (20)       68 2021-04-15 14:46:29.000000 edc-0.5.81/requirements.tests/edc_offline.txt
--rw-r--r--   0 erikvw     (501) staff       (20)       55 2024-02-13 18:05:12.000000 edc-0.5.81/requirements.tests/lint.txt
--rw-r--r--   0 erikvw     (501) staff       (20)       11 2022-07-30 01:15:42.000000 edc-0.5.81/requirements.tests/mysql.txt
--rw-r--r--   0 erikvw     (501) staff       (20)       22 2021-01-28 19:17:27.000000 edc-0.5.81/requirements.tests/postgres.txt
--rw-r--r--   0 erikvw     (501) staff       (20)      159 2024-03-27 20:17:30.000000 edc-0.5.81/requirements.tests/test_utils.txt
--rw-r--r--   0 erikvw     (501) staff       (20)      238 2022-08-23 12:40:42.000000 edc-0.5.81/requirements.tests/third_party_dev.txt
--rw-r--r--   0 erikvw     (501) staff       (20)       50 2022-05-03 03:22:05.000000 edc-0.5.81/requirements.tests/tox.txt
--rw-r--r--   0 erikvw     (501) staff       (20)     2962 2024-04-11 00:26:43.382750 edc-0.5.81/setup.cfg
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2024-04-11 00:26:43.381449 edc-0.5.81/utils/
--rw-r--r--   0 erikvw     (501) staff       (20)        0 2021-02-09 03:49:51.000000 edc-0.5.81/utils/__init__.py
--rw-r--r--   0 erikvw     (501) staff       (20)      721 2022-05-03 03:22:05.000000 edc-0.5.81/utils/get_edc_requirements.py
...
### Comparing `edc-0.5.81/.gitignore` & `edc-0.5.9/.gitignore`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/.pre-commit-config.yaml` & `edc-0.5.9/.pre-commit-config.yaml`
...
### Comparing `edc-0.5.81/CHANGES` & `edc-0.5.9/CHANGES`
...
### Comparing `edc-0.5.81/LICENSE` & `edc-0.5.9/LICENSE`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/README.rst` & `edc-0.5.9/PKG-INFO`
...
### Comparing `edc-0.5.81/bin/nginx/edc-uat.conf` & `edc-0.5.9/bin/nginx/edc-uat.conf`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/bin/nginx/edc.conf` & `edc-0.5.9/bin/nginx/edc.conf`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/bin/scripts/dev_repos.sh` & `edc-0.5.9/bin/scripts/dev_repos.sh`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/bin/scripts/update_edc.sh` & `edc-0.5.9/bin/scripts/update_edc.sh`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/bin/systemd/celery-uat.service` & `edc-0.5.9/bin/systemd/celery-uat.service`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/bin/systemd/celery.service` & `edc-0.5.9/bin/systemd/celery.service`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/docs/Makefile` & `edc-0.5.9/docs/Makefile`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/docs/README.rst` & `edc-0.5.9/docs/README.rst`
...
### Comparing `edc-0.5.81/docs/celery.rst` & `edc-0.5.9/docs/celery.rst`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/docs/conf.py` & `edc-0.5.9/docs/conf.py`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/docs/configure_web_services.rst` & `edc-0.5.9/docs/configure_web_services.rst`
...
### Comparing `edc-0.5.81/docs/deploy_new_droplet.rst` & `edc-0.5.9/docs/deploy_new_droplet.rst`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/docs/exporting_encrypted_data.rst` & `edc-0.5.9/docs/exporting_encrypted_data.rst`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/docs/forms_reference.md` & `edc-0.5.9/docs/forms_reference.md`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/docs/make.bat` & `edc-0.5.9/docs/make.bat`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/docs/prepare_database.rst` & `edc-0.5.9/docs/prepare_database.rst`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/docs/printing.rst` & `edc-0.5.9/docs/printing.rst`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/docs/update_deployment.rst` & `edc-0.5.9/docs/update_deployment.rst`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/edc.egg-info/SOURCES.txt` & `edc-0.5.9/edc.egg-info/SOURCES.txt`
...
### Comparing `edc-0.5.81/edc.egg-info/requires.txt` & `edc-0.5.9/edc.egg-info/requires.txt`
...
### Comparing `edc-0.5.81/image/icon-pycharm.png` & `edc-0.5.9/image/icon-pycharm.png`

 * *Files identical despite different names*

### Comparing `edc-0.5.81/requirements.tests/edc.txt` & `edc-0.5.9/requirements.tests/edc.txt`
...
### Comparing `edc-0.5.81/requirements.tests/edc_dev.txt` & `edc-0.5.9/requirements.tests/edc_dev.txt`
...
### Comparing `edc-0.5.81/setup.cfg` & `edc-0.5.9/setup.cfg`
...
### Comparing `edc-0.5.81/utils/get_edc_requirements.py` & `edc-0.5.9/utils/get_edc_requirements.py`
