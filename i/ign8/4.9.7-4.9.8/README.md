# Comparing `tmp/ign8-4.9.7.tar.gz` & `tmp/ign8-4.9.8.tar.gz`
...
### Comparing `ign8-4.9.7/src/ign8/gitea/git.py` & `ign8-4.9.8/src/ign8/gitea/git.py`
...
### Comparing `ign8-4.9.7/src/ign8/selinux/uptime.sh` & `ign8-4.9.8/src/ign8/selinux/uptime.sh`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/semaphore/__init__.py` & `ign8-4.9.8/src/ign8/semaphore/__init__.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/semaphore/semaphore.py` & `ign8-4.9.8/src/ign8/semaphore/semaphore.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/semaphore/serve.py` & `ign8-4.9.8/src/ign8/semaphore/serve.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/setup.py` & `ign8-4.9.8/src/ign8/setup.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/terraform/__init__.py` & `ign8-4.9.8/src/ign8/terraform/__init__.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/terraform/terraform.py` & `ign8-4.9.8/src/ign8/terraform/terraform.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/traefik/__init__.py` & `ign8-4.9.8/src/ign8/traefik/__init__.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/traefik/traefik.py` & `ign8-4.9.8/src/ign8/traefik/traefik.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/firewall.py` & `ign8-4.9.8/src/ign8/ui/firewall.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/init.py` & `ign8-4.9.8/src/ign8/ui/init.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/login.py` & `ign8-4.9.8/src/ign8/ui/login.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/logout.py` & `ign8-4.9.8/src/ign8/ui/logout.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/.mail.swp` & `ign8-4.9.8/src/ign8/ui/project/ignite/.mail.swp`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/ignite/__pycache__/settings.cpython-38.pyc` & `ign8-4.9.8/src/ign8/ui/project/ignite/ignite/__pycache__/settings.cpython-38.pyc`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/ignite/__pycache__/urls.cpython-38.pyc` & `ign8-4.9.8/src/ign8/ui/project/ignite/ignite/__pycache__/urls.cpython-38.pyc`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/ignite/__pycache__/wsgi.cpython-38.pyc` & `ign8-4.9.8/src/ign8/ui/project/ignite/ignite/__pycache__/wsgi.cpython-38.pyc`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/ignite/settings.py` & `ign8-4.9.8/src/ign8/ui/project/ignite/ignite/settings.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/main/__pycache__/models.cpython-38.pyc` & `ign8-4.9.8/src/ign8/ui/project/ignite/main/__pycache__/models.cpython-38.pyc`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/main/models.py` & `ign8-4.9.8/src/ign8/ui/project/ignite/main/models.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/main/templates/base.html` & `ign8-4.9.8/src/ign8/ui/project/ignite/main/templates/base.html`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/main/templates/main.html` & `ign8-4.9.8/src/ign8/ui/project/ignite/main/templates/main.html`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/main/templates/projects.html` & `ign8-4.9.8/src/ign8/ui/project/ignite/main/templates/projects.html`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/main/views.py` & `ign8-4.9.8/src/ign8/ui/project/ignite/main/views.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/manage.py` & `ign8-4.9.8/src/ign8/ui/project/ignite/manage.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/__pycache__/models.cpython-38.pyc` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/__pycache__/models.cpython-38.pyc`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/__pycache__/serializers.cpython-38.pyc` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/__pycache__/serializers.cpython-38.pyc`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/__pycache__/urls.cpython-38.pyc` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/__pycache__/urls.cpython-38.pyc`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/__pycache__/views.cpython-38.pyc` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/__pycache__/views.cpython-38.pyc`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/migrations/0001_initial.py` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/migrations/__pycache__/0001_initial.cpython-38.pyc` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/migrations/__pycache__/0001_initial.cpython-38.pyc`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/models.py` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/models.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/templates/SetroubleshootEntry_list.html` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/templates/SetroubleshootEntry_list.html`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/templates/SetroubleshootEntry_list_full.html` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/templates/SetroubleshootEntry_list_full.html`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/templates/base.html` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/templates/base.html`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/templates/host_message_sugestion_template.html` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/templates/host_message_sugestion_template.html`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/templates/host_message_template.html` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/templates/host_message_template.html`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/templates/message_list.html` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/templates/message_list.html`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/templates/selinux_event_list copy.html` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/templates/selinux_event_list copy.html`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/templates/selinux_event_list.html` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/templates/selinux_event_list.html`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/templates/selinux_list.html` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/templates/selinux_list.html`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/templates/suggestion_list.html` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/templates/suggestion_list.html`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/selinux/views.py` & `ign8-4.9.8/src/ign8/ui/project/ignite/selinux/views.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/ignite/templates/nginx.conf.j2` & `ign8-4.9.8/src/ign8/ui/project/ignite/templates/nginx.conf.j2`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/nginx.conf` & `ign8-4.9.8/src/ign8/ui/project/nginx.conf`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/nginx.conf.j2` & `ign8-4.9.8/src/ign8/ui/project/nginx.conf.j2`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/playbook.yml` & `ign8-4.9.8/src/ign8/ui/project/playbook.yml`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/project/testupload.py` & `ign8-4.9.8/src/ign8/ui/project/testupload.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/selinux.py` & `ign8-4.9.8/src/ign8/ui/selinux.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/serve.py` & `ign8-4.9.8/src/ign8/ui/serve.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/setup.py` & `ign8-4.9.8/src/ign8/ui/setup.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/start.py` & `ign8-4.9.8/src/ign8/ui/start.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/status.py` & `ign8-4.9.8/src/ign8/ui/status.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/stop.py` & `ign8-4.9.8/src/ign8/ui/stop.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/ui/ui.py` & `ign8-4.9.8/src/ign8/ui/ui.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vault/vault.py` & `ign8-4.9.8/src/ign8/vault/vault.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/getvmsbycluster.py` & `ign8-4.9.8/src/ign8/vmware/getvmsbycluster.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/helloworld.py` & `ign8-4.9.8/src/ign8/vmware/helloworld.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/tools/__init__.py` & `ign8-4.9.8/src/ign8/vmware/tools/__init__.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/tools/__pycache__/cli.cpython-311.pyc` & `ign8-4.9.8/src/ign8/vmware/tools/__pycache__/cli.cpython-311.pyc`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/tools/__pycache__/service_instance.cpython-311.pyc` & `ign8-4.9.8/src/ign8/vmware/tools/__pycache__/service_instance.cpython-311.pyc`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/tools/alarm.py` & `ign8-4.9.8/src/ign8/vmware/tools/alarm.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/tools/cli.py` & `ign8-4.9.8/src/ign8/vmware/tools/cli.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/tools/cluster.py` & `ign8-4.9.8/src/ign8/vmware/tools/cluster.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/tools/datacenter.py` & `ign8-4.9.8/src/ign8/vmware/tools/datacenter.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/tools/disk.py` & `ign8-4.9.8/src/ign8/vmware/tools/disk.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/tools/interactive_wrapper.py` & `ign8-4.9.8/src/ign8/vmware/tools/interactive_wrapper.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/tools/pbmhelper.py` & `ign8-4.9.8/src/ign8/vmware/tools/pbmhelper.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/tools/pchelper.py` & `ign8-4.9.8/src/ign8/vmware/tools/pchelper.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/tools/service_instance.py` & `ign8-4.9.8/src/ign8/vmware/tools/service_instance.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/tools/serviceutil.py` & `ign8-4.9.8/src/ign8/vmware/tools/serviceutil.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/tools/tasks.py` & `ign8-4.9.8/src/ign8/vmware/tools/tasks.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/tools/vm.py` & `ign8-4.9.8/src/ign8/vmware/tools/vm.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/vmware/vmware.py` & `ign8-4.9.8/src/ign8/vmware/vmware.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/wireguard/__init__.py` & `ign8-4.9.8/src/ign8/wireguard/__init__.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/wireguard/wireguard.py` & `ign8-4.9.8/src/ign8/wireguard/wireguard.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/zabbix/__init__.py` & `ign8-4.9.8/src/ign8/zabbix/__init__.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/src/ign8/zabbix/zabbix.py` & `ign8-4.9.8/src/ign8/zabbix/zabbix.py`

 * *Files identical despite different names*

### Comparing `ign8-4.9.7/PKG-INFO` & `ign8-4.9.8/PKG-INFO`
