# Comparing `tmp/ikctl-0.1.7.tar.gz` & `tmp/ikctl-0.1.8.tar.gz`
...
+gzip compressed data, was "ikctl-0.1.8.tar", last modified: Thu Apr 11 15:04:14 2024, max compression
```

## Comparing `ikctl-0.1.7.tar` & `ikctl-0.1.8.tar`
...
+drwxrwxr-x   0 dml       (1000) dml       (1000)        0 2024-04-11 15:04:14.517954 ikctl-0.1.8/
+-rw-rw-r--   0 dml       (1000) dml       (1000)    11357 2023-10-03 19:19:30.000000 ikctl-0.1.8/LICENSE
+-rw-r--r--   0 dml       (1000) dml       (1000)     2414 2024-04-11 15:04:14.517954 ikctl-0.1.8/PKG-INFO
+-rw-rw-r--   0 dml       (1000) dml       (1000)     2033 2024-03-24 12:40:50.000000 ikctl-0.1.8/README.md
+drwxrwxr-x   0 dml       (1000) dml       (1000)        0 2024-04-11 15:04:14.513954 ikctl-0.1.8/ikctl/
+-rw-rw-r--   0 dml       (1000) dml       (1000)       30 2024-03-24 12:13:52.000000 ikctl-0.1.8/ikctl/__init__.py
+-rw-rw-r--   0 dml       (1000) dml       (1000)     1049 2024-04-11 10:24:08.000000 ikctl-0.1.8/ikctl/commands.py
+-rw-rw-r--   0 dml       (1000) dml       (1000)     4085 2024-04-11 12:10:54.000000 ikctl-0.1.8/ikctl/config.py
+-rw-rw-r--   0 dml       (1000) dml       (1000)     1607 2024-04-11 12:11:52.000000 ikctl-0.1.8/ikctl/connect.py
+-rw-rw-r--   0 dml       (1000) dml       (1000)     1282 2023-10-19 21:13:41.000000 ikctl-0.1.8/ikctl/context.py
+-rw-rw-r--   0 dml       (1000) dml       (1000)     1408 2024-03-24 10:59:09.000000 ikctl-0.1.8/ikctl/create_config_files.py
+-rw-rw-r--   0 dml       (1000) dml       (1000)      970 2024-04-11 09:58:32.000000 ikctl-0.1.8/ikctl/execute.py
+-rw-rw-r--   0 dml       (1000) dml       (1000)      327 2023-10-03 19:22:08.000000 ikctl-0.1.8/ikctl/logs.py
+-rwxrwxr-x   0 dml       (1000) dml       (1000)      794 2024-04-11 09:56:10.000000 ikctl-0.1.8/ikctl/main.py
+-rw-rw-r--   0 dml       (1000) dml       (1000)     2943 2024-04-11 14:46:17.000000 ikctl-0.1.8/ikctl/pipeline.py
+-rw-rw-r--   0 dml       (1000) dml       (1000)      927 2024-01-06 11:24:38.000000 ikctl-0.1.8/ikctl/sftp.py
+-rw-rw-r--   0 dml       (1000) dml       (1000)     1044 2024-01-06 11:47:49.000000 ikctl-0.1.8/ikctl/view.py
+drwxrwxr-x   0 dml       (1000) dml       (1000)        0 2024-04-11 15:04:14.513954 ikctl-0.1.8/ikctl.egg-info/
+-rw-r--r--   0 dml       (1000) dml       (1000)     2414 2024-04-11 15:04:14.000000 ikctl-0.1.8/ikctl.egg-info/PKG-INFO
+-rw-rw-r--   0 dml       (1000) dml       (1000)      408 2024-04-11 15:04:14.000000 ikctl-0.1.8/ikctl.egg-info/SOURCES.txt
+-rw-rw-r--   0 dml       (1000) dml       (1000)        1 2024-04-11 15:04:14.000000 ikctl-0.1.8/ikctl.egg-info/dependency_links.txt
+-rw-rw-r--   0 dml       (1000) dml       (1000)       51 2024-04-11 15:04:14.000000 ikctl-0.1.8/ikctl.egg-info/entry_points.txt
+-rw-rw-r--   0 dml       (1000) dml       (1000)       23 2024-04-11 15:04:14.000000 ikctl-0.1.8/ikctl.egg-info/requires.txt
+-rw-rw-r--   0 dml       (1000) dml       (1000)        6 2024-04-11 15:04:14.000000 ikctl-0.1.8/ikctl.egg-info/top_level.txt
+-rw-rw-r--   0 dml       (1000) dml       (1000)       38 2024-04-11 15:04:14.517954 ikctl-0.1.8/setup.cfg
+-rw-rw-r--   0 dml       (1000) dml       (1000)      735 2024-04-11 14:58:04.000000 ikctl-0.1.8/setup.py
```

### Comparing `ikctl-0.1.7/LICENSE` & `ikctl-0.1.8/LICENSE`

 * *Files identical despite different names*

### Comparing `ikctl-0.1.7/PKG-INFO` & `ikctl-0.1.8/PKG-INFO`
...
### Comparing `ikctl-0.1.7/README.md` & `ikctl-0.1.8/README.md`

 * *Files identical despite different names*

### Comparing `ikctl-0.1.7/ikctl/commands.py` & `ikctl-0.1.8/ikctl/commands.py`
...
### Comparing `ikctl-0.1.7/ikctl/config.py` & `ikctl-0.1.8/ikctl/config.py`
...
### Comparing `ikctl-0.1.7/ikctl/connect.py` & `ikctl-0.1.8/ikctl/connect.py`
...
### Comparing `ikctl-0.1.7/ikctl/context.py` & `ikctl-0.1.8/ikctl/context.py`

 * *Files identical despite different names*

### Comparing `ikctl-0.1.7/ikctl/create_config_files.py` & `ikctl-0.1.8/ikctl/create_config_files.py`

 * *Files identical despite different names*

### Comparing `ikctl-0.1.7/ikctl/execute.py` & `ikctl-0.1.8/ikctl/execute.py`
...
### Comparing `ikctl-0.1.7/ikctl/main.py` & `ikctl-0.1.8/ikctl/main.py`

 * *Files identical despite different names*

### Comparing `ikctl-0.1.7/ikctl/pipeline.py` & `ikctl-0.1.8/ikctl/pipeline.py`
...
### Comparing `ikctl-0.1.7/ikctl/sftp.py` & `ikctl-0.1.8/ikctl/sftp.py`

 * *Files identical despite different names*

### Comparing `ikctl-0.1.7/ikctl/view.py` & `ikctl-0.1.8/ikctl/view.py`

 * *Files identical despite different names*

### Comparing `ikctl-0.1.7/ikctl.egg-info/PKG-INFO` & `ikctl-0.1.8/ikctl.egg-info/PKG-INFO`
...
### Comparing `ikctl-0.1.7/setup.py` & `ikctl-0.1.8/setup.py`
