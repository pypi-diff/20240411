# Comparing `tmp/stellrent-auth-0.0.0.tar.gz` & `tmp/stellrent-auth-0.0.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "stellrent-auth-0.0.0.tar", last modified: Thu Apr 11 16:27:30 2024, max compression
+gzip compressed data, was "stellrent-auth-0.0.1.tar", last modified: Wed Apr 10 14:42:19 2024, max compression
```

## Comparing `stellrent-auth-0.0.0.tar` & `stellrent-auth-0.0.1.tar`

### file list

```diff
@@ -1,19 +1,19 @@
-drwxr-xr-x   0 marcus    (1000) marcus    (1000)        0 2024-04-11 16:27:30.170266 stellrent-auth-0.0.0/
--rwxr-xr-x   0 marcus    (1000) marcus    (1000)     1066 2024-04-11 13:50:40.000000 stellrent-auth-0.0.0/LICENSE
--rwxr-xr-x   0 marcus    (1000) marcus    (1000)      156 2024-04-11 13:50:40.000000 stellrent-auth-0.0.0/MANIFEST.in
--rw-r--r--   0 marcus    (1000) marcus    (1000)      813 2024-04-11 16:27:30.170266 stellrent-auth-0.0.0/PKG-INFO
--rwxr-xr-x   0 marcus    (1000) marcus    (1000)       34 2024-04-11 13:50:41.000000 stellrent-auth-0.0.0/README.md
--rwxr-xr-x   0 marcus    (1000) marcus    (1000)      885 2024-04-11 15:17:55.000000 stellrent-auth-0.0.0/pyproject.toml
--rwxr-xr-x   0 marcus    (1000) marcus    (1000)       73 2024-04-11 16:27:30.170266 stellrent-auth-0.0.0/setup.cfg
--rwxr-xr-x   0 marcus    (1000) marcus    (1000)     1038 2024-04-11 15:18:38.000000 stellrent-auth-0.0.0/setup.py
-drwxr-xr-x   0 marcus    (1000) marcus    (1000)        0 2024-04-11 16:27:30.170266 stellrent-auth-0.0.0/stellrent_auth/
--rwxr-xr-x   0 marcus    (1000) marcus    (1000)       21 2024-04-11 13:50:40.000000 stellrent-auth-0.0.0/stellrent_auth/__init__.py
--rwxr-xr-x   0 marcus    (1000) marcus    (1000)     7911 2024-04-11 16:26:29.000000 stellrent-auth-0.0.0/stellrent_auth/auth.py
-drwxr-xr-x   0 marcus    (1000) marcus    (1000)        0 2024-04-11 16:27:30.170266 stellrent-auth-0.0.0/stellrent_auth.egg-info/
--rw-r--r--   0 marcus    (1000) marcus    (1000)      813 2024-04-11 16:27:30.000000 stellrent-auth-0.0.0/stellrent_auth.egg-info/PKG-INFO
--rw-r--r--   0 marcus    (1000) marcus    (1000)      338 2024-04-11 16:27:30.000000 stellrent-auth-0.0.0/stellrent_auth.egg-info/SOURCES.txt
--rw-r--r--   0 marcus    (1000) marcus    (1000)        1 2024-04-11 16:27:30.000000 stellrent-auth-0.0.0/stellrent_auth.egg-info/dependency_links.txt
--rw-r--r--   0 marcus    (1000) marcus    (1000)      103 2024-04-11 16:27:30.000000 stellrent-auth-0.0.0/stellrent_auth.egg-info/requires.txt
--rw-r--r--   0 marcus    (1000) marcus    (1000)       15 2024-04-11 16:27:30.000000 stellrent-auth-0.0.0/stellrent_auth.egg-info/top_level.txt
-drwxr-xr-x   0 marcus    (1000) marcus    (1000)        0 2024-04-11 16:27:30.170266 stellrent-auth-0.0.0/tests/
--rwxr-xr-x   0 marcus    (1000) marcus    (1000)      287 2024-04-11 16:26:49.000000 stellrent-auth-0.0.0/tests/test_environment_variables.py
...
### Comparing `stellrent-auth-0.0.0/LICENSE` & `stellrent-auth-0.0.1/LICENSE`

 * *Files identical despite different names*

### Comparing `stellrent-auth-0.0.0/PKG-INFO` & `stellrent-auth-0.0.1/PKG-INFO`
...
### Comparing `stellrent-auth-0.0.0/pyproject.toml` & `stellrent-auth-0.0.1/pyproject.toml`
...
### Comparing `stellrent-auth-0.0.0/setup.py` & `stellrent-auth-0.0.1/setup.py`
...
### Comparing `stellrent-auth-0.0.0/stellrent_auth/auth.py` & `stellrent-auth-0.0.1/stellrent_auth/auth.py`
...
### Comparing `stellrent-auth-0.0.0/stellrent_auth.egg-info/PKG-INFO` & `stellrent-auth-0.0.1/stellrent_auth.egg-info/PKG-INFO`
