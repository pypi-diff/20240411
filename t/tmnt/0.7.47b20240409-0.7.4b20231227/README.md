# Comparing `tmp/tmnt-0.7.47b20240409.tar.gz` & `tmp/tmnt-0.7.4b20231227.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "tmnt-0.7.47b20240409.tar", last modified: Tue Apr  9 23:04:53 2024, max compression
+gzip compressed data, was "tmnt-0.7.4b20231227.tar", last modified: Wed Dec 27 14:49:52 2023, max compression
```

## Comparing `tmnt-0.7.47b20240409.tar` & `tmnt-0.7.4b20231227.tar`

### file list

```diff
@@ -1,35 +1,50 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-09 23:04:53.088716 tmnt-0.7.47b20240409/
--rw-r--r--   0 runner    (1001) docker     (127)    11356 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/LICENSE
--rw-r--r--   0 runner    (1001) docker     (127)      425 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/NOTICE
--rw-r--r--   0 runner    (1001) docker     (127)     1437 2024-04-09 23:04:53.088716 tmnt-0.7.47b20240409/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      351 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/README.md
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-04-09 23:04:53.088716 tmnt-0.7.47b20240409/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)     1912 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-09 23:04:53.084716 tmnt-0.7.47b20240409/tmnt/
--rw-r--r--   0 runner    (1001) docker     (127)      250 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)    10054 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/configuration.py
--rw-r--r--   0 runner    (1001) docker     (127)    18736 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/data_loading.py
--rw-r--r--   0 runner    (1001) docker     (127)    10866 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/distribution.py
--rw-r--r--   0 runner    (1001) docker     (127)    76953 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/estimator.py
--rw-r--r--   0 runner    (1001) docker     (127)     5048 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/eval_npmi.py
--rw-r--r--   0 runner    (1001) docker     (127)    17845 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/inference.py
--rw-r--r--   0 runner    (1001) docker     (127)    33018 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/modeling.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-09 23:04:53.088716 tmnt-0.7.47b20240409/tmnt/preprocess/
--rw-r--r--   0 runner    (1001) docker     (127)      170 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/preprocess/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)    14050 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/preprocess/tokenizer.py
--rw-r--r--   0 runner    (1001) docker     (127)    15796 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/preprocess/vectorizer.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-09 23:04:53.088716 tmnt-0.7.47b20240409/tmnt/utils/
--rw-r--r--   0 runner    (1001) docker     (127)      237 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/utils/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)      795 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/utils/csv2json.py
--rw-r--r--   0 runner    (1001) docker     (127)     2075 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/utils/log_utils.py
--rw-r--r--   0 runner    (1001) docker     (127)      923 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/utils/mat_utils.py
--rw-r--r--   0 runner    (1001) docker     (127)     1451 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/utils/ngram_helpers.py
--rw-r--r--   0 runner    (1001) docker     (127)     1274 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/utils/pubmed_utils.py
--rw-r--r--   0 runner    (1001) docker     (127)      327 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/utils/random.py
--rw-r--r--   0 runner    (1001) docker     (127)     1439 2024-04-09 23:04:42.000000 tmnt-0.7.47b20240409/tmnt/utils/recalibrate.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-09 23:04:53.088716 tmnt-0.7.47b20240409/tmnt.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)     1437 2024-04-09 23:04:53.000000 tmnt-0.7.47b20240409/tmnt.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      607 2024-04-09 23:04:53.000000 tmnt-0.7.47b20240409/tmnt.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-09 23:04:53.000000 tmnt-0.7.47b20240409/tmnt.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)      300 2024-04-09 23:04:53.000000 tmnt-0.7.47b20240409/tmnt.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)        5 2024-04-09 23:04:53.000000 tmnt-0.7.47b20240409/tmnt.egg-info/top_level.txt
...
### Comparing `tmnt-0.7.47b20240409/LICENSE` & `tmnt-0.7.4b20231227/LICENSE`

 * *Files identical despite different names*

### Comparing `tmnt-0.7.47b20240409/PKG-INFO` & `tmnt-0.7.4b20231227/PKG-INFO`
...
### Comparing `tmnt-0.7.47b20240409/setup.py` & `tmnt-0.7.4b20231227/setup.py`
...
### Comparing `tmnt-0.7.47b20240409/tmnt/configuration.py` & `tmnt-0.7.4b20231227/tmnt/configuration.py`

 * *Files identical despite different names*

### Comparing `tmnt-0.7.47b20240409/tmnt/data_loading.py` & `tmnt-0.7.4b20231227/tmnt/data_loading.py`
...
### Comparing `tmnt-0.7.47b20240409/tmnt/distribution.py` & `tmnt-0.7.4b20231227/tmnt/distribution.py`
...
### Comparing `tmnt-0.7.47b20240409/tmnt/estimator.py` & `tmnt-0.7.4b20231227/tmnt/estimator.py`
...
### Comparing `tmnt-0.7.47b20240409/tmnt/eval_npmi.py` & `tmnt-0.7.4b20231227/tmnt/eval_npmi.py`

 * *Files identical despite different names*

### Comparing `tmnt-0.7.47b20240409/tmnt/inference.py` & `tmnt-0.7.4b20231227/tmnt/inference.py`
...
### Comparing `tmnt-0.7.47b20240409/tmnt/modeling.py` & `tmnt-0.7.4b20231227/tmnt/modeling.py`
...
### Comparing `tmnt-0.7.47b20240409/tmnt/preprocess/tokenizer.py` & `tmnt-0.7.4b20231227/tmnt/preprocess/tokenizer.py`

 * *Files identical despite different names*

### Comparing `tmnt-0.7.47b20240409/tmnt/preprocess/vectorizer.py` & `tmnt-0.7.4b20231227/tmnt/preprocess/vectorizer.py`

 * *Files identical despite different names*

### Comparing `tmnt-0.7.47b20240409/tmnt/utils/csv2json.py` & `tmnt-0.7.4b20231227/tmnt/utils/csv2json.py`

 * *Files identical despite different names*

### Comparing `tmnt-0.7.47b20240409/tmnt/utils/log_utils.py` & `tmnt-0.7.4b20231227/tmnt/utils/log_utils.py`

 * *Files identical despite different names*

### Comparing `tmnt-0.7.47b20240409/tmnt/utils/mat_utils.py` & `tmnt-0.7.4b20231227/tmnt/utils/mat_utils.py`

 * *Files identical despite different names*

### Comparing `tmnt-0.7.47b20240409/tmnt/utils/ngram_helpers.py` & `tmnt-0.7.4b20231227/tmnt/utils/ngram_helpers.py`

 * *Files identical despite different names*

### Comparing `tmnt-0.7.47b20240409/tmnt/utils/pubmed_utils.py` & `tmnt-0.7.4b20231227/tmnt/utils/pubmed_utils.py`

 * *Files identical despite different names*

### Comparing `tmnt-0.7.47b20240409/tmnt/utils/recalibrate.py` & `tmnt-0.7.4b20231227/tmnt/utils/recalibrate.py`

 * *Files identical despite different names*

### Comparing `tmnt-0.7.47b20240409/tmnt.egg-info/PKG-INFO` & `tmnt-0.7.4b20231227/tmnt.egg-info/PKG-INFO`
