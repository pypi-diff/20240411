# Comparing `tmp/ts-soup-0.1.2.tar.gz` & `tmp/ts-soup-0.1.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "D:\PythonProjects\GDtrading\ts-soup\dist\.tmp-yn0fjlay\ts-soup-0.1.2.tar", last modified: Tue Apr  9 05:28:37 2024, max compression
...
## Comparing `ts-soup-0.1.2.tar` & `ts-soup-0.1.3.tar`

### file list

```diff
@@ -1,18 +1,18 @@
-drwxrwxrwx   0        0        0        0 2024-04-09 05:28:37.755907 ts-soup-0.1.2/
--rw-rw-rw-   0        0        0     1028 2024-04-09 05:28:37.754711 ts-soup-0.1.2/PKG-INFO
--rw-rw-rw-   0        0        0      686 2024-04-07 01:22:11.000000 ts-soup-0.1.2/README.md
--rw-rw-rw-   0        0        0       42 2024-04-09 05:28:37.755907 ts-soup-0.1.2/setup.cfg
--rw-rw-rw-   0        0        0      607 2024-04-09 05:28:18.000000 ts-soup-0.1.2/setup.py
-drwxrwxrwx   0        0        0        0 2024-04-09 05:28:37.742060 ts-soup-0.1.2/ts_soup/
--rw-rw-rw-   0        0        0      373 2024-04-09 03:17:12.000000 ts-soup-0.1.2/ts_soup/__init__.py
--rw-rw-rw-   0        0        0     1418 2024-04-07 01:22:11.000000 ts-soup-0.1.2/ts_soup/app.py
--rw-rw-rw-   0        0        0    15530 2024-04-09 03:12:17.000000 ts-soup-0.1.2/ts_soup/common.py
-drwxrwxrwx   0        0        0        0 2024-04-09 05:28:37.751129 ts-soup-0.1.2/ts_soup/workers/
--rw-rw-rw-   0        0        0       78 2024-04-07 01:22:11.000000 ts-soup-0.1.2/ts_soup/workers/__init__.py
--rw-rw-rw-   0        0        0     3689 2024-04-07 01:22:11.000000 ts-soup-0.1.2/ts_soup/workers/sources.py
--rw-rw-rw-   0        0        0     4331 2024-04-09 05:28:18.000000 ts-soup-0.1.2/ts_soup/workers/targets.py
-drwxrwxrwx   0        0        0        0 2024-04-09 05:28:37.753129 ts-soup-0.1.2/ts_soup.egg-info/
--rw-rw-rw-   0        0        0     1028 2024-04-09 05:28:37.000000 ts-soup-0.1.2/ts_soup.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      277 2024-04-09 05:28:37.000000 ts-soup-0.1.2/ts_soup.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-04-09 05:28:37.000000 ts-soup-0.1.2/ts_soup.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0        8 2024-04-09 05:28:37.000000 ts-soup-0.1.2/ts_soup.egg-info/top_level.txt
...
### Comparing `ts-soup-0.1.2/PKG-INFO` & `ts-soup-0.1.3/PKG-INFO`
...
### Comparing `ts-soup-0.1.2/README.md` & `ts-soup-0.1.3/README.md`

 * *Files identical despite different names*

### Comparing `ts-soup-0.1.2/setup.py` & `ts-soup-0.1.3/setup.py`
...
### Comparing `ts-soup-0.1.2/ts_soup/app.py` & `ts-soup-0.1.3/ts_soup/app.py`

 * *Files identical despite different names*

### Comparing `ts-soup-0.1.2/ts_soup/common.py` & `ts-soup-0.1.3/ts_soup/common.py`
...
### Comparing `ts-soup-0.1.2/ts_soup/workers/sources.py` & `ts-soup-0.1.3/ts_soup/workers/sources.py`
...
### Comparing `ts-soup-0.1.2/ts_soup/workers/targets.py` & `ts-soup-0.1.3/ts_soup/workers/targets.py`
...
### Comparing `ts-soup-0.1.2/ts_soup.egg-info/PKG-INFO` & `ts-soup-0.1.3/ts_soup.egg-info/PKG-INFO`
